...
class HelyszinAdapter(private val helyszinLista: ArrayList<Helyszin>, private val listener: OnItemClickListener) : RecyclerView.Adapter<HelyszinAdapter.MyViewHolder>(){
